...
public class MyGridViewAdpter extends BaseAdapter {
    ...
    private List<WenkeBean> lists;//数据源
    private int mIndex; // 页数下标，标示第几页，从0开始
    private int mPargerSize;// 每页显示的最大的数量



    public MyGridViewAdpter(Context context, List<WenkeBean> lists,
    ...
    @Override
    public WenkeBean getItem(int arg0) {
        // TODO Auto-generated method stub
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = View.inflate(context, R.layout.wenke_detail_item, null);
        ...
        holder.tv_name.setText(lists.get(pos).getActivity() + "");
        holder.iv_nul.setImageResource(lists.get(pos).getImgid());
        //holder.tv_name.setBackgroundResource(R.drawable.shadow);
        //添加item监听
